...
class WaveformProcessor:
    ...
    def __init__(self, config: dict):
        """Initializes the processor using a config dictionary."""
        ...
        # Parse endpoint-channel mapping from JSON
        ...
        try:
            ...
            if wfset:
                ...
                if self.save_single_file:
                    return wfset  # Return processed data for merging
                else:
    ...
    def read_and_save(self) -> bool:
        """Reads waveforms in parallel, applies filters, and saves them."""
